...
### Country -> Channel -> Country Recode

Instead of coding the data as flowing from country to country through a channel, consider coding the data as flowing fro country to channel to country. This has not yet been completed (or even started).
...
Exclude data from debt repayments.

```{r}
## remove rows corresponding to funder_country == "Debt_repayments"
core_data <- core_data[-which(core_data$funder_country == "Debt_repayments"),]
```
