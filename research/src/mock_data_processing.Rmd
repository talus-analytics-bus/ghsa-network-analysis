...
demo_data_sim$amount_dispersed[which(demo_data_sim$core_element == "Prevent")] <- 
  rnorm(n = sum(demo_data_sim$core_element == "Prevent"),
        mean = 0.9, sd = 0.005) * demo_data_sim$amount_committed[which(demo_data_sim$core_element == "Prevent")]
...
demo_data_sim$amount_dispersed[which(demo_data_sim$core_element == "Detect")] <- 
  rnorm(n = sum(demo_data_sim$core_element == "Detect"),
        mean = 0.98, sd = 0.001) * demo_data_sim$amount_committed[which(demo_data_sim$core_element == "Detect")]
...
demo_data_sim$amount_dispersed[which(demo_data_sim$core_element == "Respond")] <- 
  rnorm(n = sum(demo_data_sim$core_element == "Respond"),
        mean = 1.2, sd = 0.1) * demo_data_sim$amount_committed[which(demo_data_sim$core_element == "Respond")]
...
demo_data_sim$amount_dispersed[which(demo_data_sim$core_element == "Other")] <- 
  rnorm(n = sum(demo_data_sim$core_element == "Other"),
        mean = 1, sd = 0.07) * demo_data_sim$amount_committed[which(demo_data_sim$core_element == "Other")]
...
```{r, eval = FALSE}
ggplot(demo_data_sim, aes(amount_committed, fill = core_element)) +
  geom_histogram(binwidth = 500)
```

```{r}
ggplot(demo_data_sim, aes(amount_committed, fill = funder_country)) +
  geom_histogram(binwidth = 500)
```
