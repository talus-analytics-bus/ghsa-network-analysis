...
if(csv_flag == TRUE){
  ...
  ## save development dataset
    write.csv(core_data[which(core_data$in_sample == TRUE),],
...
```{r}
table(core_data$data_source)
table(core_data[which(core_data$in_sample == TRUE &
                      core_data$data_source == "GAVI"),]$core_capability)
