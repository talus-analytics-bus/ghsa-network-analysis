Subdirectories included only for international funding information that is somewhat disaggregated at either the project or focus area level. For example, WHO SPP data are not included as a subdirectory as data are aggregated by funder and recipient. This make it impossible to tag funding by function or focus area.
